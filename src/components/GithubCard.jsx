  ...
  return (
    <div className="w-[376px] rounded-[7px] border-[1.5px] border-[#cecece] bg-[#ebeaea] p-4">
      <div className="flex items-start justify-between gap-2">
        <span className="font-mona-sans text-sm font-semibold text-[#2e69d3]">
          {name}
        </span>
      ...
      {description && (
        <p className="mt-2 font-mona-sans text-[10px] text-[#5a636d]">
          {description}
        </p>
      )}
      ...
      <div className="mt-3 flex items-center gap-1.5">
        ...
        />
        <span className="font-mona-sans text-[11px] text-[#5a636d]">
          {language}
        </span>
      </div>
    </div>
...
export default function GithubCard() {
  return (
    <a
      href="https://github.com/mattyemuna"
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Open Matthew Emuna's GitHub profile"
      className="block w-[1250px] cursor-pointer"
    >
      <CometCard>
        <div className="relative z-10 flex w-[1250px] gap-[54px] rounded-[10px] bg-[#ebebeb] p-8">
          <div className="flex w-[264px] shrink-0 flex-col">
            <div className="mb-4 flex items-center gap-2 text-black">
              ...
              <span className="font-mona-sans text-sm font-semibold">
                GitHub
              </span>
            </div>
            ...
            <p className="mt-[-2px] font-mona-sans text-2xl leading-none text-[#5a5959]">
              mattyemuna
            </p>
            ...
            <div className="mt-8 flex items-center gap-1.5 text-[#6d6a6a]">
              ...
              <span className="font-mona-sans text-xl">
                New York, NY
              </span>
            </div>
          </div>
          ...
          <div className="flex-1">
            <p className="mb-4 font-mona-sans text-sm text-black">
